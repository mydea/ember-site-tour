...
k(n)}return i}}throw new Error("illegal catch attempt")},delegateYield:function(e,t,n){return this.delegate={iterator:C(e),resultName:t,nextLoc:n},d}}}function f(e,n,r,i){var o=n&&n.prototype instanceof b?n:b,s=Object.create(o.prototype),a=new x(i||[])
...
e._setStrings=e._getStrings=void 0,Object.defineProperty(e,"_getStrings",{enumerable:!0,get:function(){return t.getStrings}}),Object.defineProperty(e,"_setStrings",{enumerable:!0,get:function(){return t.setStrings}}),e.loc=_,e.w=E,e.decamelize=w,e.dasherize=k,e.camelize=x,e.classify=C,e.underscore=O,e.capitalize=P
...
for(e=arguments.length,t=Array(e),n=0;n<e;n++)t[n]=arguments[n]
return _(this,t)}},camelize:{configurable:!0,enumerable:!1,writeable:!0,value:function(){return x(this)}},decamelize:{configurable:!0,enumerable:!1,writeable:!0,value:function(){return w(this)}},dasherize:{configurable:!0,enumerable:!1,writeable:!0,value:function(){return k(this)}},underscore:{configurable:!0,enumerable:!1,writeable:!0,value:function(){return O(this)}},classify:{configurable:!0,enumerable:!1,writeable:!0,value:function(){return C(this)}},capitalize:{configurable:!0,enumerable:!1,writeable:!0,value:function(){return P(this)}}})}),e("@ember/string/lib/string_registry",["exports"],function(e){"use strict"
...
d=n}d?(this.pushYieldableBlock(d),k.push({symbol:l+1,isBlock:!0})):(this.pushYieldableBlock(null),k.push({symbol:l+1,isBlock:!0}))
break
case"@":if(!s)break
h=s[0],f=s[1],m=c,a&&(m=c.slice(1)),-1!==(b=h.indexOf(m))&&(this.expr(f[b]),k.push({symbol:l+1,isBlock:!1}))}for(this.pushRootScope(w.length+1,!!(u||_||n)),g=k.length-1;g>=0;g--)y=(v=k[g]).symbol,v.isBlock?this.setBlock(y):this.setVariable(y)
...
this.primitive(t)},t.prototype.resolveBlock=function(){},t.prototype.pushLayout=function(e){e?this.primitive(e.compile()):this.primitive(null)},t.prototype.resolveLayout=function(){},t.prototype.invokeStatic=function(e){var t=e.compile();-1===t?this.pushMachine(50,function(){return e.compile()}):this.pushMachine(50,t)},t}(P),R=function(e){function t(t,r,i){var o=new a.LazyConstants(r),s=new a.Program(o)
...
this.blocks=t,this.inlines=n},e.LazyCompiler=R,e.compile=_,e.AbstractCompiler=w,e.debugCompiler=void 0,e.CompilableBlock=y,e.CompilableProgram=v,e.LazyOpcodeBuilder=S,e.EagerOpcodeBuilder=T,e.OpcodeBuilder=P,e.StdOpcodeBuilder=O,e.PartialDefinition=A,e.templateFactory=function(e){var t=e.id,n=e.meta,i=e.block,o=void 0,s=t||"client-"+N++
...
r!==l&&i.push(r)}return f(i)},e.CachedTag=m,e.UpdatableTag=v,e.CachedReference=_,e.map=function(e,t){return new E(e,t)},e.ReferenceCache=w,e.isModified=function(e){return e!==k}}),e("@glimmer/runtime",["exports","ember-babel","@glimmer/util","@glimmer/reference","@glimmer/vm","@glimmer/low-level"],function(e,t,n,r,i,o){"use strict"
...
function E(e){return w(e)?"":String(e)}function w(e){return null==e||"function"!=typeof e.toString}function k(e){return"object"==typeof e&&null!==e&&"function"==typeof e.toHTML}function x(e){return"object"==typeof e&&null!==e&&"number"==typeof e.nodeType}function C(e){return"string"==typeof e}var O=function(e){function n(n,r,i){var o=(0,t.possibleConstructorReturn)(this,e.call(this))
...
var r=null
return y(n)?r=n:"string"==typeof n&&n&&(r=I(this.resolver,n,this.meta)),r=this.curry(r),this.lastValue=n,this.lastDefinition=r,r},e.prototype.get=function(){return p},e.prototype.curry=function(e){var t=this.args
...
W(e.getSelf().value(),function(e){return s.get(e).value()})}),s.add(95,function(e,t){var n,r,i,o,s,a,u,l,c,p,d,h,f=t.op1,m=t.op2,b=t.op3,g=e.constants,v=e.constants.resolver,y=e.stack.pop().value(),_=g.getSerializable(f),E=g.getStringArray(m),w=g.getArray(b),k=v.lookupPartial(y,_),x=v.resolve(k).getPartial(),C=x.symbolTable,O=x.handle
...
function _e(e,t){return-1!==e.indexOf(t)}function Ee(e,t){return(null===e||_e(be,e))&&_e(ve,t)}function we(e,t){return null!==e&&(_e(ge,e)&&_e(ye,t))}function ke(e,t){return Ee(e,t)||we(e,t)}function xe(e,t,n,r){var i,o=null
if(null==r)return r
...
return"attr"===s?Se(r,a,i):function(e,t,n){if(ke(e,t))return new Ne(t,n)
...
return new Ae(t,n)}(r,a,i)}function Se(e,t,n){return ke(e,t)?new Me(n):new Re(n)}var Te=function(e){this.attribute=e},Re=function(e){function n(){return(0,t.possibleConstructorReturn)(this,e.apply(this,arguments))}return(0,t.inherits)(n,e),n.prototype.set=function(e,t){var n,r,i,o=Le(t)
...
n?t.removeAttributeNS(n,this.normalizedName):t.removeAttribute(this.normalizedName)},n}(Te),Ne=function(e){function n(){return(0,t.possibleConstructorReturn)(this,e.apply(this,arguments))}return(0,t.inherits)(n,e),n.prototype.set=function(t,n,r){var i=this.attribute,o=xe(r,i.element,i.name,n)
...
e.prototype.set.call(this,t,o,r)},n.prototype.update=function(t,n){var r=this.attribute,i=xe(n,r.element,r.name,t)
e.prototype.update.call(this,i,n)},n}(Re),je=function(e){function n(){return(0,t.possibleConstructorReturn)(this,e.apply(this,arguments))}return(0,t.inherits)(n,e),n.prototype.set=function(e,t){e.__setProperty("value",E(t))},n.prototype.update=function(e){var t=this.attribute.element,n=t.value,r=E(e)
n!==r&&(t.value=r)},n}(Ae),Ie=function(e){function n(){return(0,t.possibleConstructorReturn)(this,e.apply(this,arguments))}return(0,t.inherits)(n,e),n.prototype.set=function(e,t){null!=t&&!1!==t&&e.__setProperty("selected",!0)},n.prototype.update=function(e){var t=this.attribute.element
t.selected=!!e},n}(Ae)
...
this._transaction=null,e.commit()},e.prototype.attributeFor=function(e,t){return Pe(e,t,arguments.length>3&&void 0!==arguments[3]?arguments[3]:null)},(0,t.createClass)(e,[{key:"transaction",get:function(){return this._transaction}}]),e}(),ze=function(e){function n(n){var r
...
return t&&t[1]?Number(t[1]):null}function kt(e){return 1===e.nodeType}function xt(e){return 8===e.nodeType&&"%glmr%"===e.nodeValue}function Ct(e){return 8===e.nodeType&&"% %"===e.nodeValue}function Ot(e,t){var n,r
...
return new vt(n,r)},e.LowLevelVM=bt,e.UpdatingVM=Ze,e.RenderResult=ot,e.SimpleDynamicAttribute=Re,e.DynamicAttribute=Te,e.EMPTY_ARGS=mt,e.Scope=De,e.Environment=Fe,e.DefaultEnvironment=ze,e.DEFAULT_CAPABILITIES={dynamicLayout:!0,dynamicTag:!0,prepareArgs:!0,createArgs:!0,attributeHook:!1,elementHook:!1,dynamicScope:!0,createCaller:!1,updateHook:!0,createInstance:!0},e.MINIMAL_CAPABILITIES={dynamicLayout:!1,dynamicTag:!1,prepareArgs:!1,createArgs:!1,attributeHook:!1,elementHook:!1,dynamicScope:!1,createCaller:!1,updateHook:!1,createInstance:!1},e.CurriedComponentDefinition=_,e.isCurriedComponentDefinition=y,e.curry=function(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null
...
return[l,u,a]}function b(){var e,t=void 0,n=void 0,r=void 0,i=void 0,o=void 0
return 2===arguments.length?(n=arguments[0],o=arguments[1],t=null):(t=(e=m.apply(void 0,arguments))[0],n=e[1],void 0===(i=e[2])?o=0:s(o=i.pop())||(r=!0===o,o=i.pop())),[t,n,i,o=parseInt(o,10),r]}var g=0,v=0,y=0,_=0,E=0,w=0,k=0,x=0,C=0,O=0,P=0,S=0,T=0,R=0,A=0,N=0,M=0,j=0,I=0,L=0,D=0,B=function(){function e(e,t){var n=this
this.DEBUG=!1,this.currentInstance=null,this.instanceStack=[],this._eventCallbacks={end:[],begin:[]},this._timerTimeoutId=null,this._timers=[],this._autorun=null,this.queueNames=e,this.options=t||{},"string"==typeof this.options.defaultQueue?this._defaultQueue=this.options.defaultQueue:this._defaultQueue=this.queueNames[0],this._onBegin=this.options.onBegin||h,this._onEnd=this.options.onEnd||h,this._boundRunExpiredTimers=this._runExpiredTimers.bind(this),this._boundAutorunEnd=function(){I++,null!==n._autorun&&(n._autorun=null,n._end(!0))}
...
var e,t=b.apply(void 0,arguments),n=t[0],r=t[1],i=t[2],o=t[3],s=t[4],a=void 0===s||s,u=l(n,r,this._timers),c=void 0
return-1===u?(c=this._later(n,r,a?f:i,o),a&&this._join(n,r,i)):(c=this._timers[u+1],e=u+4,this._timers[e]!==f&&(this._timers[e]=i)),c},e.prototype.debounce=function(){A++
var e,t,n=b.apply(void 0,arguments),r=n[0],i=n[1],o=n[2],s=n[3],a=n[4],u=void 0!==a&&a,c=l(r,i,this._timers),p=void 0
...
this._autorun=e()},(0,t.createClass)(e,[{key:"counters",get:function(){return{begin:v,end:y,events:{begin:_,end:0},autoruns:{created:j,completed:I},run:E,join:w,defer:k,schedule:x,scheduleIterable:C,deferOnce:O,scheduleOnce:P,setTimeout:S,later:T,throttle:R,debounce:A,cancelTimers:N,cancel:M,loops:{total:L,nested:D}}}},{key:"defaultQueue",get:function(){return this._defaultQueue}}]),e}()
...
var O,P,S,T,R,A,N=(0,i.taggedTemplateLiteralLoose)(["template:components/-default"],["template:components/-default"]),M=(0,i.taggedTemplateLiteralLoose)(["component:-default"],["component:-default"]),j=(0,i.taggedTemplateLiteralLoose)(["template:-root"],["template:-root"]),I=(0,i.taggedTemplateLiteralLoose)(["template-compiler:main"],["template-compiler:main"])
...
return e.forEach(function(e){return n.push(e)}),this.from(n,t)},t.prototype.valueFor=function(e){return this.array[e]},t}(Ce),Pe=function(e){function t(t,n,r){var o=(0,i.possibleConstructorReturn)(this,e.call(this,n,r))
return o.array=t,o}return(0,i.inherits)(t,e),t.from=function(e,t){var n=e.length
...
return e.forEach(function(e,t){(s=s||n.length>=2)&&r.push(t),i.push(e),o++}),0===o?Ne:s?new this(r,i,o,t):new Oe(i,o,t)},t.prototype.valueFor=function(e){return this.values[e]},t.prototype.memoFor=function(e){return this.keys[e]},t}(Ce),Te=function(){function e(e,t,n){this.iterable=e,this.result=t,this.keyFor=n,this.position=0}return e.from=function(e,t){var n=e[Symbol.iterator](),r=n.next(),i=r.value
return r.done?Ne:Array.isArray(i)&&2===i.length?new this(n,r,t):new Re(n,r,t)},e.prototype.isEmpty=function(){return!1},e.prototype.next=function(){var e=this.iterable,t=this.result,n=this.position,r=this.keyFor
if(t.done)return null
var i=this.valueFor(t,n),o=this.memoFor(t,n),s=r(i,o,n)
return this.position++,this.result=e.next(),{key:s,value:i,memo:o}},e}(),Re=function(e){function t(){return(0,i.possibleConstructorReturn)(this,e.apply(this,arguments))}return(0,i.inherits)(t,e),t.prototype.valueFor=function(e){return e.value},t.prototype.memoFor=function(e,t){return t},t}(Te),Ae=function(e){function t(){return(0,i.possibleConstructorReturn)(this,e.apply(this,arguments))}return(0,i.inherits)(t,e),t.prototype.valueFor=function(e){return e.value[1]},t.prototype.memoFor=function(e){return e.value[0]},t}(Te),Ne={isEmpty:function(){return!0},next:function(){return null}},Me=function(){function e(e,t){this.ref=e,this.keyPath=t,this.valueTag=a.UpdatableTag.create(a.CONSTANT_TAG),this.tag=(0,a.combine)([e.tag,this.valueTag])}return e.prototype.iterate=function(){var e,t=this.ref,n=this.valueTag,r=t.value(),i=(0,c.tagFor)(r)
return(0,l.isProxy)(r)&&(r=(0,u._contentFor)(r)),n.inner.update(i),null===(e=r)||"object"!=typeof e&&"function"!=typeof e?Ne:Array.isArray(r)||(0,u.isEmberArray)(r)?Se.fromIndexable(r,this.keyFor(!0)):l.HAS_NATIVE_SYMBOL&&Le(r)?Ae.from(r,this.keyFor()):Ie(r)?Se.fromForEachable(r,this.keyFor()):Se.fromIndexable(r,this.keyFor(!0))},e.prototype.valueReferenceFor=function(e){return new Z(e.value)},e.prototype.updateValueReference=function(e,t){e.update(t.value)},e.prototype.memoReferenceFor=function(e){return new Z(e.memo)},e.prototype.updateMemoReference=function(e,t){e.update(t.memo)},e.prototype.keyFor=function(){var e=arguments.length>0&&void 0!==arguments[0]&&arguments[0],t=this.keyPath
switch(t){case"@key":return e?Be:He(Fe)
case"@index":return De
case"@identity":return He(ze)
default:return He(Ue(t))}},e}(),je=function(){function e(e,t){this.ref=e,this.keyPath=t,this.valueTag=a.UpdatableTag.create(a.CONSTANT_TAG),this.tag=(0,a.combine)([e.tag,this.valueTag])}return e.prototype.iterate=function(){var e=this.ref,t=this.valueTag,n=e.value()
if(t.inner.update((0,c.tagForProperty)(n,"[]")),null===n||"object"!=typeof n)return Ne
var r=this.keyFor()
return Array.isArray(n)?Oe.from(n,r):(0,u.isEmberArray)(n)?Pe.from(n,r):l.HAS_NATIVE_SYMBOL&&Le(n)?Re.from(n,r):Ie(n)?Oe.fromForEachable(n,r):Ne},e.prototype.valueReferenceFor=function(e){return new Z(e.value)},e.prototype.updateValueReference=function(e,t){e.update(t.value)},e.prototype.memoReferenceFor=function(e){return new Z(e.memo)},e.prototype.updateMemoReference=function(e,t){e.update(t.memo)},e.prototype.keyFor=function(){var e=this.keyPath
switch(e){case"@index":return De
case"@identity":return He(ze)
default:return He(Ue(e))}},e}()
function Ie(e){return"function"==typeof e.forEach}function Le(e){return"function"==typeof e[Symbol.iterator]}function De(e,t,n){return String(n)}function Be(e,t){return t}function Fe(e,t){return ze(t)}function ze(e){switch(typeof e){case"string":return e
...
var wt=(0,w.privatize)(N),kt=function(e){function r(){return(0,i.possibleConstructorReturn)(this,e.apply(this,arguments))}return(0,i.inherits)(r,e),r.prototype.getLayout=function(e){return{handle:e.handle,symbolTable:e.symbolTable}},r.prototype.templateFor=function(e,t){var n,r=(0,c.get)(e,"layout")
...
function xt(e){return e.instrumentDetails({initialRender:!0})}function Ct(e){return e.instrumentDetails({initialRender:!1})}var Ot={dynamicLayout:!0,dynamicTag:!0,prepareArgs:!0,createArgs:!0,attributeHook:!0,elementHook:!0,createCaller:!0,dynamicScope:!0,updateHook:!0,createInstance:!0},Pt=new kt,St=function(e,t,n,r,i){this.name=e,this.ComponentClass=t,this.handle=n,this.manager=Pt
...
for(e=0;e<jt.length;e++)jt[e]._scheduleRevalidate()}),k.backburner.on("end",function(){var e,t
...
return Bt++,k.backburner.join(null,Lt)}Bt=0,null!==Dt&&(t=Dt.resolve,Dt=null,k.backburner.join(null,t))})
...
return(0,f.flaggedInstrument)("interaction.ember-action",i,function(){return k.join.apply(void 0,[s,a].concat(r(t)))})}}var un=function(e){return function(e){return null==e||"function"!=typeof e.toString}(e)?"":String(e)}
...
var t=e.named
return new C.QueryParams((0,g.assign)({},t.value()))}var gn=["alt","shift","meta","ctrl"],vn=/^click|mouse|touch/
...
return r.component.static(i,[t,kn(n),null,null]),!0}function On(e,t,n,r){var i,o,s,a,u
...
r.tag.validate(i)||(t=r.value(),e.modelRev=r.tag.value(),n.set("model",t))},t}(tt)),Rn=function(e,t){this.manager=Tn,this.state={name:e,modelRef:t}}
...
t.set("model",n.value())},t.prototype.getCapabilities=function(){return T},t.prototype.getTag=function(e){return e.model.tag},t.prototype.getDestructor=function(e){return e.controller},t}(O),Fn=new R,Un=function(e,t,n){this.manager=n,this.state={name:e,template:t}})
var Hn=void 0
...
return null!==s&&(pt(n),o.component.static(s,[t,kn(n),r,i]),!0)}E.RENDER_HELPER&&(Vn=function(e,t,n,r){var i
...
return dn.create(n.at(0),n.at(2),n.at(1))},"-class":function(e,t){return new re(tn,t.capture())},"-each-in":function(e,t){return new ke(t.positional.at(0))},"-input-type":function(e,t){return new re(rn,t.capture())},"-normalize-class":function(e,t){return new re(on,t.capture())},"-html-safe":function(e,t){return new re(nn,t.capture())},"-get-dynamic-var":t.getDynamicVar,"-mount":function(e,t){var n=e.env,r=t.positional.at(0),i=t.named.has("model")?t.named.get("model"):void 0
...
var m=u||l?new St(s,l||t.owner.factoryFor((0,w.privatize)(M)),null,u):null
...
e.RootTemplate=B,e.template=L,e.Checkbox=be,e.TextField=ve,e.TextArea=ye,e.LinkComponent=Ee,e.Component=fe,e.ROOT_REF=ce,e.Helper=z,e.helper=H,e.Environment=et,e.SafeString=Ve,e.escapeExpression=function(e){if("string"!=typeof e){if(e&&e.toHTML)return e.toHTML()
if(null==e)return""
if(!e)return e+""
e=""+e}return We.test(e)?e.replace(Ge,Ye):e},e.htmlSafe=Qe,e.isHTMLSafe=Ke,e.Renderer=Ft,e.InertRenderer=zt,e.InteractiveRenderer=Ut,e._resetRenderers=function(){jt.length=0},e.renderSettled=function(){return null===Dt&&(Dt=x.default.defer(),(0,k.getCurrentRunLoop)()||k.backburner.schedule("actions",null,Lt)),Dt.promise},e.getTemplate=function(e){if(Ht.hasOwnProperty(e))return Ht[e]},e.setTemplate=function(e,t){return Ht[e]=t},e.hasTemplate=function(e){return Ht.hasOwnProperty(e)},e.getTemplates=function(){return Ht},e.setTemplates=function(e){Ht=e},e.setupEngineRegistry=function(e){e.register("view:-outlet",sr),e.register("template:-outlet",rr),e.injection("view:-outlet","template","template:-outlet"),e.injection("service:-dom-changes","document","service:-document"),e.injection("service:-dom-tree-construction","document","service:-document"),e.register((0,w.privatize)(N),nr),e.register("service:-glimmer-environment",et),e.register((0,w.privatize)(I),tr),e.injection("template","compiler",(0,w.privatize)(I)),e.optionsForType("helper",{instantiate:!1}),e.register("helper:loc",Vt),e.register("component:-text-field",ve),e.register("component:-text-area",ye),e.register("component:-checkbox",be),e.register("component:link-to",Ee),v.ENV._TEMPLATE_ONLY_GLIMMER_COMPONENTS||e.register((0,w.privatize)(M),fe)},e.setupApplicationRegistry=function(e){e.injection("service:-glimmer-environment","appendOperations","service:-dom-tree-construction"),e.injection("renderer","env","service:-glimmer-environment"),e.register("service:-dom-builder",{create:function(e){switch(e.bootOptions._renderMode){case"serialize":return r.serializeBuilder.bind(null)
case"rehydrate":return t.rehydrationBuilder.bind(null)
default:return t.clientBuilder.bind(null)}}}),e.injection("service:-dom-builder","bootOptions","-environment:main"),e.injection("renderer","builder","service:-dom-builder"),e.register((0,w.privatize)(j),B),e.injection("renderer","rootTemplate",(0,w.privatize)(j)),e.register("renderer:-dom",Ut),e.register("renderer:-inert",zt),h.hasDOM&&e.injection("service:-glimmer-environment","updateOperations","service:-dom-changes"),e.register("service:-dom-changes",{create:function(e){var n=e.document
...
return s||(o[t]=C())}function P(e,t){return"object"==typeof e&&null!==e?(void 0===t?(0,a.meta)(e):t).writableTag(C):l.CONSTANT_TAG}var S=void 0
...
var A=(0,r.symbol)("PROPERTY_DID_CHANGE"),N=new k,M=0,j=void 0
...
return r(e,"@array:before",t,o),r(e,"@array:change",t,s),a===i&&L(e,"hasArrayObservers"),e}function le(e,t,n,r){_(e,y(t),n,r),Pe(e,t)}function ce(e,t,n,r){Te(e,t),E(e,y(t),n,r)}function pe(e){var t=Y.get(e)
...
for(ke(e);Ee.length>0;)ke(t=Ee.pop()),we(t)}(this):we(this)},e.prototype.copyTo=function(e){var t,n=this.paths
...
i>0&&(r.writeWatching(t,i-1),1===i&&r.writableChains(ve).remove(t))}}function Pe(e,t,n){v(t)?Ce(e,t,n):W(e,t,n)}function Se(e,t){var n=(0,a.peekMeta)(e)
return void 0!==n&&n.peekWatching(t)||0}function Te(e,t,n){v(t)?Oe(e,t,n):G(e,t,n)}function Re(e,t,n,r){var i,o,s=e._dependentKeys
if(null!=s)for(i=0;i<s.length;i++)o=s[i],r.writeDeps(o,n,r.peekDeps(o,n)+1),Pe(t,o,r)}function Ae(e,t,n,r){var i,o,s=e._dependentKeys
if(null!=s)for(i=0;i<s.length;i++)o=s[i],r.writeDeps(o,n,r.peekDeps(o,n)-1),Te(t,o,r)}var Ne=/\.@each$/
...
t+=n.substring(0,r)
u=l.length
for(;s<u;)(a=c.indexOf("{"))<0?i((t+l[s++]+c).replace(Ne,".[]")):e(t+l[s++],c,a,i)}("",e,n,t)}function je(e,t,n,r){if(!e.isDestroyed){if(v(t))return function(e,t,n,r){var i=t.split("."),o=i.pop()
...
if(i&&o===s)return s
var u=(0,a.meta)(e)
return i||Re(this,e,t,u),r.set(t,s),L(e,t,u),s},n.prototype.teardown=function(e,t,n){if(!this._volatile){var r=b(e)
...
n.peekWatching(t)>0&&Re(this,e,t,n)},n.prototype.teardown=function(e,t,n){n.peekWatching(t)>0&&Ae(this,e,t,n)},n.prototype.willWatch=function(e,t,n){Re(this,e,t,n)},n.prototype.didUnwatch=function(e,t,n){Ae(this,e,t,n)},n.prototype.get=function(e,t){var n,r=ne(e,this.altKey),i=f(e)
return i.get(t)!==Fe&&(n=(0,a.meta)(e),i.set(t,Fe),Re(this,e,t,n)),r},n.prototype.set=function(e,t,n){return je(e,this.altKey,n)},n.prototype.readOnly=function(){return this.set=Ue,this},n.prototype.oneWay=function(){return this.set=He,this},n}(V)
function Ue(e,t){throw new c.default("Cannot set read-only property '"+t+"' on object: "+(0,r.inspect)(e))}function He(e,t,n){return q(e,t,null),je(e,t,n)}function Ve(e){var t,n,r=null==e
if(r)return r
if("number"==typeof e.size)return!e.size
var i=typeof e
return"object"===i&&"number"==typeof(t=ne(e,"size"))?!t:"number"==typeof e.length&&"function"!==i?!e.length:"object"===i&&"number"==typeof(n=ne(e,"length"))&&!n}function qe(e){return Ve(e)||"string"==typeof e&&!1===/\S/.test(e)}ze.prototype._meta=void 0,ze.prototype.meta=Le.prototype.meta
...
e.computed=De,e.ComputedProperty=Le,e._globalsComputed=Be,e.getCacheFor=f,e.getCachedValueFor=m,e.peekCacheFor=b,e.alias=function(e){return new ze(e)},e.deprecateProperty=function(e,t,n,r){Object.defineProperty(e,t,{configurable:!0,enumerable:!1,set:function(e){je(this,n,e)},get:function(){return ne(this,n)}})},e.PROXY_CONTENT=te,e._getPath=re,e.get=ne,e.getWithDefault=function(e,t,n){var r=ne(e,t)
...
e.isEmpty=Ve,e.isBlank=qe,e.isPresent=function(e){return!qe(e)},e.beginPropertyChanges=z,e.changeProperties=H,e.endPropertyChanges=U,e.notifyPropertyChange=L,e.overrideChains=F,e.propertyDidChange=I,e.propertyWillChange=j,e.PROPERTY_DID_CHANGE=A,e.defineProperty=q,e.Descriptor=V,e.watchKey=W,e.unwatchKey=G,e.ChainNode=xe,e.finishChains=function(e){var t=e.readableChainWatchers()
void 0!==t&&t.revalidateAll(),void 0!==e.readableChains()&&e.writableChains(ve)},e.removeChainWatcher=_e,e.watchPath=Ce,e.unwatchPath=Oe,e.isWatching=function(e,t){return Se(e,t)>0},e.unwatch=Te,e.watch=Pe,e.watcherCount=Se,e.libraries=Ge,e.Libraries=We,e.getProperties=function(e){var t={},n=arguments,r=1
...
return(0,r.setObservers)(o,a),o},e.applyMixin=ht,e.InjectedProperty=gt,e.setHasViews=function(e){x=e},e.tagForProperty=O,e.tagFor=P,e.markObjectAsDirty=T,e.runInTransaction=R,e.didRender=void 0,e.assertNotRendered=void 0,e.descriptor=function(e){return new yt(e)},e.tracked=function(e,t,n){return"value"in n?function(e,t){var n=Symbol(e)
return{enumerable:!0,configurable:!0,get:function(){return Z&&Z.add(O(this,e)),n in this||(this[n]=t.value),this[n]},set:function(t){P(this).inner.dirty(),S(O(this,e)),this[n]=t,ee()}}}(t,n):function(e,t){var n=t.get,r=t.set
return{enumerable:!0,configurable:!1,get:n&&function(){var t=Z,r=Z=new J,i=n.call(this)
Z=t
var o=r.combine()
return Z&&Z.add(o),(void 0)(O(this,e),o),i},set:r&&function(){S(O(this,e)),r.apply(this,arguments)}}}(t,n)},e.NAMESPACES=Xe,e.NAMESPACES_BY_ID=Je,e.addNamespace=function(e){Ke.unprocessedNamespaces=!0,Xe.push(e)},e.classToString=nt,e.findNamespace=function(e){return Qe||tt(),Je[e]},e.findNamespaces=Ze,e.processNamespace=et,e.processAllNamespaces=tt,e.removeNamespace=function(e){var t=(0,r.getName)(e)
...
var h,f
e.MutableArray=e.NativeArray=e.A=void 0,e.isEmberArray=function(e){return e&&e[b]},e.uniqBy=v,e.isArray=C,e.removeAt=S
...
return-1===i?void 0:(0,n.objectAt)(e,i)}function w(e,t,n){return-1!==_(e,t.bind(n),0)}function k(e,t,n){var r=t.bind(n)
...
return(0,n.beginPropertyChanges)(this),e.forEach(function(e){return t.addObject(e)}),(0,n.endPropertyChanges)(this),this}}),R=n.Mixin.create(T,u.default,{objectAt:function(e){return this[e]},replace:function(e,t){var r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:m
...
var N=void 0
a.ENV.EXTEND_PROTOTYPES.Array?(R.apply(Array.prototype),e.A=N=function(e){return e||[]}):e.A=N=function(e){return e||(e=[]),O.detect(e)?e:R.apply(e)},e.A=N,e.NativeArray=R,e.MutableArray=T,e.default=O}),e("ember-runtime/lib/mixins/comparable",["exports","ember-metal"],function(e,t){"use strict"
...
r.BINDING_SUPPORT&&p.ENV._ENABLE_BINDING_SUPPORT&&u.Mixin.finishPartial(this,w),(t=this).init.apply(t,arguments),w.proto=k,(0,u.finishChains)(w),(0,u.sendEvent)(this,"init",void 0,void 0,void 0,w)}return e._initFactory=function(e){f.set(this,e)},e.prototype.reopen=function(){var e,t,n
for(e=arguments.length,t=Array(e),n=0;n<e;n++)t[n]=arguments[n]
...
return this._super=n,r}return k.add(n),v(n,y(e)),E(n,w(e)),n}var C=Object.prototype.toString,O=Function.prototype.toString,P=Array.isArray,S=Object.keys,T=JSON.stringify,R=100,A=4,N=/^[\w$]+$/
...
var r,i="["
for(r=0;r<e.length;r++){if(i+=0===r?" ":", ",r>=R){i+="... "+(e.length-R)+" more items"
break}i+=M(e[r],t,n)}return i+=" ]"}(e,t+1,n):function(e,t,n){if(t>A)return"[Object]"
var r,i,o="{",s=S(e)
for(r=0;r<s.length;r++){if(o+=0===r?" ":", ",r>=R){o+="... "+(s.length-R)+" more keys"
break}i=s[r],o+=j(i)+": "+M(e[i],t,n)}return o+=" }"}(e,t+1,n)}function j(e){return N.test(e)?e:T(e)}function I(e,t){return null!=e&&"function"==typeof e[t]}var L=Array.isArray,D=new WeakMap,B=Object.prototype.toString
...
return n(e)?void 0===(r=o.get(e))&&(r="ember"+i(),o.set(e,r)):void 0===(r=s.get(e))&&(r="string"===(t=typeof e)?"st"+i():"number"===t?"nu"+i():"symbol"===t?"sy"+i():"("+e+")",s.set(e,r)),r},e.intern=t,e.checkHasSuper=h,e.ROOT=m,e.wrap=function(e,t){return b(e)?!k.has(t)&&b(t)?x(e,x(t,m)):x(e,t):e},e.getObservers=y,e.getListeners=w,e.setObservers=v,e.setListeners=E,e.inspect=function(e){return"number"==typeof e&&2===arguments.length?this:M(e,0)},e.lookupDescriptor=function(e,t){var n,r=e
...
F.NoneLocation=w.NoneLocation,F.controllerFor=w.controllerFor,F.generateControllerFactory=w.generateControllerFactory,F.generateController=w.generateController,F.RouterDSL=w.RouterDSL,F.Router=w.Router,F.Route=w.Route,(0,S.runLoadHooks)("Ember.Application",S.default),F.DataAdapter=k.DataAdapter,F.ContainerDebugAdapter=k.ContainerDebugAdapter,(0,t.has)("ember-template-compiler")&&(0,t.default)("ember-template-compiler"),(0,t.has)("ember-testing")&&(B=(0,t.default)("ember-testing"),F.Test=B.Test,F.Test.Adapter=B.Adapter,F.Test.QUnitAdapter=B.QUnitAdapter,F.setupForTesting=B.setupForTesting),(0,S.runLoadHooks)("Ember"),e.default=F,r.IS_NODE?r.module.exports=F:n.context.exports.Ember=n.context.exports.Em=F}),e("ember/version",["exports"],function(e){"use strict"
e.default="3.4.4"}),e("node-module",["exports"],function(e){var t="object"==typeof module&&"function"==typeof module.require
...
return{names:u||_,shouldDecodes:c||_}}function w(e,t,n){return e.char===t&&e.negate===n}var k=function(e,t,n,r,i){this.states=e,this.id=t,this.char=n,this.negate=r,this.nextStates=i?t:null,this.pattern="",this._regex=void 0,this.handlers=void 0,this.types=void 0}
...
if(null!==o)if(h(o)){for(n=0;n<o.length;n++)if(w(r=this.states[o[n]],e,t))return r}else if(w(i=this.states[o],e,t))return i},k.prototype.put=function(e,t,n){var r
if(r=this.get(e,t))return r
var i=this.states
return r=new k(i,i.length,e,t,n),i[i.length]=r,null==this.nextStates?this.nextStates=r.id:h(this.nextStates)?this.nextStates.push(r.id):this.nextStates=[this.nextStates,r.id],r},k.prototype.match=function(e){var t,n,r,i=this.nextStates
if(!i)return[]
var o=[]
...
for(b.length=d.length,r=0;r<d.length;r++){if(o=(i=d[r]).names,s=i.shouldDecodes,a=y,u=!1,o!==_&&s!==_)for(l=0;l<o.length;l++)u=!0,c=o[l],p=f&&f[m++],a===y&&(a={}),S.ENCODE_AND_DECODE_PATH_SEGMENTS&&s[l]?a[c]=p&&decodeURIComponent(p):a[c]=p
...
return/_id$/.test(i)?r[i]=t.id:r[i]=t,r}},r}(k),O=function(e){function n(n){var r=(0,t.possibleConstructorReturn)(this,e.call(this,n))
return r.params=r.params||{},r}return(0,t.inherits)(n,e),n.prototype.getModel=function(e){var t=this.params
e&&e.queryParams&&(s(t={},this.params),t.queryParams=e.queryParams)
var n=this.handler,r=m(n,"deserialize")||m(n,"model")
return this.runSharedModelHook(e,r,[t])},n}(k)
function P(e,t){var n=new(0,P.klasses[e])(t||{})
return n.factory=P,n}P.klasses={resolved:x,param:O,object:C}
...
u[a]=o[a]}return P("param",{name:e,getHandler:t,params:u})},n}(E)
...
return e}for(u=0,l=p.length;u<l;++u)(o=(i=P("param",{name:(r=p[u]).handler,getHandler:n,params:r.params})).handler)?f(o):i.handlerPromise=i.handlerPromise.then(f),a=e.handlerInfos[u],d||i.shouldSupercede(a)?(d=!0,c.handlerInfos[u]=i):c.handlerInfos[u]=a
...
for(r=0,i=s.entered.length;r<i;r++)I(u,s.entered[r],!0,n)}catch(l){throw e.state=a,e.currentHandlerInfos=a.handlerInfos,l}e.state.queryParams=z(e,u,t.queryParams,n)}function I(e,t,n,r){var i=t.handler,o=t.context
...
return a&&a.hasOwnProperty("queryParams")&&(u=A.call(t).queryParams),0===t.length?(l(e,"Updating query params"),r=e.state.handlerInfos,o=new S({name:r[r.length-1].name,contexts:[],queryParams:u})):"/"===s.charAt(0)?(l(e,"Attempting URL transition to "+s),o=new R({url:s})):(l(e,"Attempting transition to "+s),o=new S({name:t[0],contexts:i.call(t,1),queryParams:u})),e.transitionByIntent(o,n)}function B(e,t){var n,r
if(e.length!==t.length)return!1
...
t.constructor===e.constructor&&n===S&&e.constructor.resolve===c?function(e,t){t._state===h?k(e,t._result):t._state===f?(t._onError=null,x(e,t._result)):C(t,void 0,function(n){t===n?k(e,n):E(e,n)},function(t){return x(e,t)})}(e,t):n===m?(r=m.error,m.error=null,x(e,r)):"function"==typeof n?function(e,t,n){s.async(function(e){var r,i=!1,o=y(n).call(t,function(n){i||(i=!0,t===n?k(e,n):E(e,n))},function(t){i||(i=!0,x(e,t))},"Settle: "+(e._label||" unknown promise"))
i||o!==m||(i=!0,r=m.error,m.error=null,x(e,r))},e)}(e,t,n):k(e,t)}function E(e,t){var n,r
e===t?k(e,t):(r=typeof(n=t),null===n||"object"!==r&&"function"!==r?k(e,t):_(e,t,b(t)))}function w(e){e._onError&&e._onError(e._result),O(e)}function k(e,t){e._state===d&&(e._result=t,e._state=h,0===e._subscribers.length?s.instrument&&l("fulfilled",e):s.async(O,e))}function x(e,t){e._state===d&&(e._state=f,e._result=t,s.async(w,e))}function C(e,t,n,r){var i=e._subscribers,o=i.length
...
s=o?y(n)(r):r,t._state!==d||(s===t?x(t,new TypeError("A promises callback cannot return that same promise.")):s===m?(i=m.error,m.error=null,x(t,i)):o?E(t,s):e===h?k(t,s):e===f&&x(t,s))}function S(e,t,n){var r,i=this._state
if(i===h&&!e||i===f&&!t)return s.instrument&&l("chained",this,this),this
this._onError=null
var o=new this.constructor(p,n),a=this._result
return s.instrument&&l("chained",this,o),i===d?C(this,o,e,t):(r=i===h?e:t,s.async(function(){return P(i,o,r,a)})),o}var T=function(){function e(e,t,n,r){this._instanceConstructor=e,this.promise=new e(p,r),this._abortOnReject=n,this._isUsingOwnPromise=e===M,this._isUsingOwnResolve=e.resolve===c,this._init.apply(this,arguments)}return e.prototype._init=function(e,t){var n=t.length||0
...
function R(e,t,n){this._remaining--,this._result[t]=e===h?{state:"fulfilled",value:n}:{state:"rejected",reason:n}}var A="rsvp_"+Date.now()+"-",N=0
...
return y(n).apply(r,t)===m&&(i=m.error,m.error=null,x(e,i)),e}function D(e){return null!==e&&"object"==typeof e&&(e.constructor===M||b(e))}function B(e,t){return M.all(e,t)}M.cast=c,M.all=function(e,t){return Array.isArray(e)?new T(this,e,!0,t).promise:this.reject(new TypeError("Promise.all must be called with an array"),t)},M.race=function(e,t){var n,r=new this(p,t)
if(!Array.isArray(e))return x(r,new TypeError("Promise.race must be called with an array")),r
for(n=0;r._state===d&&n<e.length;n++)C(this.resolve(e[n]),void 0,function(e){return E(r,e)},function(e){return x(r,e)})
return r},M.resolve=c,M.reject=function(e,t){var n=new this(p,t)
return x(n,e),n},M.prototype._guidKey=A,M.prototype.then=S
...
function z(e,t){return Array.isArray(e)?new F(M,e,t).promise:M.reject(new TypeError("Promise.allSettled must be called with an array"),t)}function U(e,t){return M.race(e,t)}F.prototype._setResultAt=R
...
return t.promise=new M(function(e,n){t.resolve=e,t.reject=n},e),t}q.prototype._setResultAt=R
...
r?(i=y(this._mapFn)(n,t))===m?this._settledAt(f,t,i.error,!1):this._eachEntry(i,t,!1):(this._remaining--,this._result[t]=n)},n}(T)
...
e.default={asap:re,cast:ye,Promise:M,EventTarget:o,all:B,allSettled:z,race:U,hash:V,hashSettled:W,rethrow:G,defer:Y,denodeify:I,configure:a,on:Ee,off:we,resolve:$,reject:X,map:K,async:_e,filter:ee},e.asap=re,e.cast=ye,e.Promise=M,e.EventTarget=o,e.all=B,e.allSettled=z,e.race=U,e.hash=V,e.hashSettled=W,e.rethrow=G,e.defer=Y,e.denodeify=I,e.configure=a,e.on=Ee,e.off=we,e.resolve=$,e.reject=X,e.map=K,e.async=_e,e.filter=ee}),t("ember")}(),function(e,t){"object"==typeof exports&&"undefined"!=typeof module?module.exports=t():"function"==typeof define&&define.amd?define(t):e.hopscotch=t()}(this,function(){"use strict"
var e,t,n,r,i,o,s,a,u,l,c,p,d="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},h="bubble_default",f=window.Sizzle||null,m=!1,b="undefined"!==("undefined"==typeof jQuery?"undefined":d(jQuery)),g=!1,v=!1,y=/^[a-zA-Z]+[a-zA-Z0-9_-]*$/,_={left:"right",right:"left"}
try{"undefined"!==d(window.sessionStorage)&&(g=!0,sessionStorage.setItem("hopscotch.test.storage","ok"),sessionStorage.removeItem("hopscotch.test.storage"),v=!0)}catch(E){}return c={smoothScroll:!0,scrollDuration:1e3,scrollTopMargin:200,showCloseButton:!0,showPrevButton:!1,showNextButton:!0,bubbleWidth:280,bubblePadding:15,arrowWidth:20,skipIfNoElement:!0,isRtl:!1,cookieName:"hopscotch.tour.state"},Array.isArray||(Array.isArray=function(e){return"[object Array]"===Object.prototype.toString.call(e)}),(a={addClass:function(e,t){var n,r,i,o
if(e.className){for(r=t.split(/\s+/),n=" "+e.className+" ",i=0,o=r.length;i<o;++i)n.indexOf(" "+r[i]+" ")<0&&(n+=r[i]+" ")
e.className=n.replace(/^\s+|\s+$/g,"")}else e.className=t},removeClass:function(e,t){var n,r,i,o
for(r=t.split(/\s+/),n=" "+e.className+" ",i=0,o=r.length;i<o;++i)n=n.replace(" "+r[i]+" "," ")
e.className=n.replace(/^\s+|\s+$/g,"")},hasClass:function(e,t){return!!e.className&&-1!==(" "+e.className+" ").indexOf(" "+t+" ")},getPixelValue:function(e){var t=void 0===e?"undefined":d(e)
return"number"===t?e:"string"===t?parseInt(e,10):0},valOrDefault:function(e,t){return"undefined"!==(void 0===e?"undefined":d(e))?e:t},invokeCallbackArrayHelper:function(e){var t
if(Array.isArray(e)&&"function"==typeof(t=l[e[0]]))return t.apply(this,e.slice(1))},invokeCallbackArray:function(e){var t,n
if(Array.isArray(e)){if("string"==typeof e[0])return a.invokeCallbackArrayHelper(e)
for(t=0,n=e.length;t<n;++t)a.invokeCallback(e[t])}},invokeCallback:function(e){return"function"==typeof e?e():"string"==typeof e&&l[e]?l[e]():a.invokeCallbackArray(e)},invokeEventCallbacks:function(e,t){var n,r,i=u[e]
if(t)return this.invokeCallback(t)
for(n=0,r=i.length;n<r;++n)this.invokeCallback(i[n].cb)},getScrollTop:function(){return"undefined"!==d(window.pageYOffset)?window.pageYOffset:document.documentElement.scrollTop},getScrollLeft:function(){return"undefined"!==d(window.pageXOffset)?window.pageXOffset:document.documentElement.scrollLeft},getWindowHeight:function(){return window.innerHeight||document.documentElement.clientHeight},addEvtListener:function(e,t,n){if(e)return e.addEventListener?e.addEventListener(t,n,!1):e.attachEvent("on"+t,n)},removeEvtListener:function(e,t,n){if(e)return e.removeEventListener?e.removeEventListener(t,n,!1):e.detachEvent("on"+t,n)},documentIsReady:function(){return"complete"===document.readyState},evtPreventDefault:function(e){e.preventDefault?e.preventDefault():event&&(event.returnValue=!1)},extend:function(e,t){var n
for(n in t)t.hasOwnProperty(n)&&(e[n]=t[n])},getStepTargetHelper:function(e){var t=document.getElementById(e)
if(t)return t
if(b)return(t=jQuery(e)).length?t[0]:null
...
if("string"==typeof e.target)return a.getStepTargetHelper(e.target)
if(Array.isArray(e.target)){var n,r
for(n=0,r=e.target.length;n<r;n++)if("string"==typeof e.target[n]&&(t=a.getStepTargetHelper(e.target[n])))return t
return null}return e.target},getI18NString:function(e){return i[e]||r[e]},setState:function(e,t,n){var r,i=""
if(g&&v)try{sessionStorage.setItem(e,t)}catch(E){v=!1,this.setState(e,t,n)}else g&&sessionStorage.removeItem(e),n&&((r=new Date).setTime(r.getTime()+24*n*60*60*1e3),i="; expires="+r.toGMTString()),document.cookie=e+"="+t+i+"; path=/"},getState:function(e){var t,n,r,i=e+"=",o=document.cookie.split(";")
if(g&&(r=sessionStorage.getItem(e)))return r
for(t=0;t<o.length;t++){for(n=o[t];" "===n.charAt(0);)n=n.substring(1,n.length)
if(0===n.indexOf(i)){r=n.substring(i.length,n.length)
break}}return r},clearState:function(e){g?sessionStorage.removeItem(e):this.setState(e,"",-1)},normalizePlacement:function(e){!e.placement&&e.orientation&&(e.placement=e.orientation)},flipPlacement:function(e){if(e.isRtl&&!e._isFlipped){var t,n,r=["orientation","placement"]
for(n in e.xOffset&&(e.xOffset=-1*this.getPixelValue(e.xOffset)),r)t=r[n],e.hasOwnProperty(t)&&_.hasOwnProperty(e[t])&&(e[t]=_[e[t]])
e._isFlipped=!0}}}).addEvtListener(window,"load",function(){m&&p.startTour()}),u={next:[],prev:[],start:[],end:[],show:[],error:[],close:[]},l={},r={stepNums:null,nextBtn:"Next",prevBtn:"Back",doneBtn:"Done",skipBtn:"Skip",closeTooltip:"Close"},i={},(t=function(e){this.init(e)}).prototype={isShowing:!1,currStep:void 0,setPosition:function(e){var t,n,r,i,o,s,u,l=a.getStepTarget(e),c=this.element,p=this.arrowEl,d=e.isRtl?"right":"left"
if(a.flipPlacement(e),a.normalizePlacement(e),n=c.offsetWidth,t=c.offsetHeight,a.removeClass(c,"fade-in-down fade-in-up fade-in-left fade-in-right"),r=l.getBoundingClientRect(),u=e.isRtl?r.right-n:r.left,"top"===e.placement)i=r.top-t-this.opt.arrowWidth,o=u
else if("bottom"===e.placement)i=r.bottom+this.opt.arrowWidth,o=u
else if("left"===e.placement)i=r.top,o=r.left-n-this.opt.arrowWidth
else{if("right"!==e.placement)throw new Error("Bubble placement failed because step.placement is invalid or undefined!")
i=r.top,o=r.right+this.opt.arrowWidth}(s="center"!==e.arrowOffset?a.getPixelValue(e.arrowOffset):e.arrowOffset)?"top"===e.placement||"bottom"===e.placement?(p.style.top="",p.style[d]="center"===s?Math.floor(n/2-p.offsetWidth/2)+"px":s+"px"):"left"!==e.placement&&"right"!==e.placement||(p.style[d]="",p.style.top="center"===s?Math.floor(t/2-p.offsetHeight/2)+"px":s+"px"):(p.style.top="",p.style[d]=""),"center"===e.xOffset?o=r.left+l.offsetWidth/2-n/2:o+=a.getPixelValue(e.xOffset),"center"===e.yOffset?i=r.top+l.offsetHeight/2-t/2:i+=a.getPixelValue(e.yOffset),e.fixedElement||(i+=a.getScrollTop(),o+=a.getScrollLeft()),c.style.position=e.fixedElement?"fixed":"absolute",c.style.top=i+"px",c.style.left=o+"px"},render:function(e,t,n){var r,i,s,u,l,c,d,f,m,b,g=this.element
if(e?this.currStep=e:this.currStep&&(e=this.currStep),this.opt.isTourBubble?(u=p.getCurrTour())&&(i=u.customData,r=u.customRenderer,e.isRtl=e.hasOwnProperty("isRtl")?e.isRtl:u.hasOwnProperty("isRtl")?u.isRtl:this.opt.isRtl,s=u.unsafe,Array.isArray(u.steps)&&(l=u.steps.length,c=this._getStepI18nNum(this._getStepNum(l-1)),f=this._getStepNum(t)===this._getStepNum(l-1))):(i=e.customData,r=e.customRenderer,s=e.unsafe,e.isRtl=e.hasOwnProperty("isRtl")?e.isRtl:this.opt.isRtl),d=f?a.getI18NString("doneBtn"):e.showSkip?a.getI18NString("skipBtn"):a.getI18NString("nextBtn"),a.flipPlacement(e),a.normalizePlacement(e),this.placement=e.placement,b={i18n:{prevBtn:a.getI18NString("prevBtn"),nextBtn:d,closeTooltip:a.getI18NString("closeTooltip"),stepNum:this._getStepI18nNum(this._getStepNum(t)),numSteps:c},buttons:{showPrev:a.valOrDefault(e.showPrevButton,this.opt.showPrevButton)&&this._getStepNum(t)>0,showNext:a.valOrDefault(e.showNextButton,this.opt.showNextButton),showCTA:a.valOrDefault(e.showCTAButton&&e.ctaLabel,!1),ctaLabel:e.ctaLabel,showClose:a.valOrDefault(this.opt.showCloseButton,!0)},step:{num:t,isLast:a.valOrDefault(f,!1),title:e.title||"",content:e.content||"",isRtl:e.isRtl,placement:e.placement,padding:a.valOrDefault(e.padding,this.opt.bubblePadding),width:a.getPixelValue(e.width)||this.opt.bubbleWidth,customData:e.customData||{}},tour:{isTour:this.opt.isTourBubble,numSteps:l,unsafe:a.valOrDefault(s,!1),customData:i||{}}},"function"==typeof r)g.innerHTML=r(b)
else if("string"==typeof r){if(!p.templates||"function"!=typeof p.templates[r])throw new Error('Bubble rendering failed - template "'+r+'" is not a function.')
g.innerHTML=p.templates[r](b)}else if(o)g.innerHTML=o(b)
else{if(!p.templates||"function"!=typeof p.templates[h])throw new Error('Bubble rendering failed - template "'+h+'" is not a function.')
g.innerHTML=p.templates[h](b)}var v,y=g.children,_=y.length
for(m=0;m<_;m++)v=y[m],a.hasClass(v,"hopscotch-arrow")&&(this.arrowEl=v)
return g.style.zIndex="number"==typeof e.zindex?e.zindex:"",this._setArrow(e.placement),this.hide(!1),this.setPosition(e),n&&n(!e.fixedElement),this},_getStepNum:function(e){var t,n=0,r=p.getSkippedStepsIndexes(),i=r.length
for(t=0;t<i;t++)r[t]<e&&n++
return e-n},_getStepI18nNum:function(e){var t=a.getI18NString("stepNums")
return t&&e<t.length?e=t[e]:e+=1,e},_setArrow:function(e){a.removeClass(this.arrowEl,"down up right left"),"top"===e?a.addClass(this.arrowEl,"down"):"bottom"===e?a.addClass(this.arrowEl,"up"):"left"===e?a.addClass(this.arrowEl,"right"):"right"===e&&a.addClass(this.arrowEl,"left")},_getArrowDirection:function(){return"top"===this.placement?"down":"bottom"===this.placement?"up":"left"===this.placement?"right":"right"===this.placement?"left":void 0},show:function(){var e=this,t="fade-in-"+this._getArrowDirection()
return a.removeClass(this.element,"hide"),a.addClass(this.element,t),setTimeout(function(){a.removeClass(e.element,"invisible")},50),setTimeout(function(){a.removeClass(e.element,t)},1e3),this.isShowing=!0,this},hide:function(e){var t=this.element
return e=a.valOrDefault(e,!0),t.style.top="",t.style.left="",e?(a.addClass(t,"hide"),a.removeClass(t,"invisible")):(a.removeClass(t,"hide"),a.addClass(t,"invisible")),a.removeClass(t,"animate fade-in-up fade-in-down fade-in-right fade-in-left"),this.isShowing=!1,this},destroy:function(){var e=this.element
e&&e.parentNode.removeChild(e),a.removeEvtListener(e,"click",this.clickCb)},_handleBubbleClick:function(e){var t
if("cta"===(t=function t(n){return n===e.currentTarget?null:a.hasClass(n,"hopscotch-cta")?"cta":a.hasClass(n,"hopscotch-next")?"next":a.hasClass(n,"hopscotch-prev")?"prev":a.hasClass(n,"hopscotch-close")?"close":t(n.parentElement)}((e=e||window.event).target||e.srcElement)))this.opt.isTourBubble||p.getCalloutManager().removeCallout(this.currStep.id),this.currStep.onCTA&&a.invokeCallback(this.currStep.onCTA)
else if("next"===t)p.nextStep(!0)
else if("prev"===t)p.prevStep(!0)
else if("close"===t){if(this.opt.isTourBubble){var n=p.getCurrStepNum()===p.getCurrTour().steps.length-1
a.invokeEventCallbacks("close"),p.endTour(!0,n)}else this.opt.onClose&&a.invokeCallback(this.opt.onClose),this.opt.id&&!this.opt.isTourBubble?p.getCalloutManager().removeCallout(this.opt.id):this.destroy()
a.evtPreventDefault(e)}},init:function(e){var t,n,r,i,o=document.createElement("div"),s=this,u=!1
this.element=o,i={showPrevButton:c.showPrevButton,showNextButton:c.showNextButton,bubbleWidth:c.bubbleWidth,bubblePadding:c.bubblePadding,arrowWidth:c.arrowWidth,isRtl:c.isRtl,showNumber:!0,isTourBubble:!0},e="undefined"===(void 0===e?"undefined":d(e))?{}:e,a.extend(i,e),this.opt=i,o.className="hopscotch-bubble animated",i.isTourBubble?(r=p.getCurrTour())&&a.addClass(o,"tour-"+r.id):a.addClass(o,"hopscotch-callout no-number"),t=function(){!u&&s.isShowing&&(u=!0,setTimeout(function(){s.setPosition(s.currStep),u=!1},100))},a.addEvtListener(window,"resize",t),this.clickCb=function(e){s._handleBubbleClick(e)},a.addEvtListener(o,"click",this.clickCb),this.hide(),a.documentIsReady()?document.body.appendChild(o):(document.addEventListener?(n=function(){document.removeEventListener("DOMContentLoaded",n),window.removeEventListener("load",n),document.body.appendChild(o)},document.addEventListener("DOMContentLoaded",n,!1)):(n=function(){"complete"===document.readyState&&(document.detachEvent("onreadystatechange",n),window.detachEvent("onload",n),document.body.appendChild(o))},document.attachEvent("onreadystatechange",n)),a.addEvtListener(window,"load",n))}},n=function(){var e={},n={}
this.createCallout=function(r){var i
if(!r.id)throw new Error("Must specify a callout id.")
if(!y.test(r.id))throw new Error("Callout ID is using an invalid format. Use alphanumeric, underscores, and/or hyphens only. First character must be a letter.")
if(e[r.id])throw new Error("Callout by that id already exists. Please choose a unique id.")
if(!a.getStepTarget(r))throw new Error("Must specify existing target element via 'target' option.")
return r.showNextButton=r.showPrevButton=!1,r.isTourBubble=!1,i=new t(r),e[r.id]=i,n[r.id]=r,i.render(r,null,function(){i.show(),r.onShow&&a.invokeCallback(r.onShow)}),i},this.getCallout=function(t){return e[t]},this.removeAllCallouts=function(){var t
for(t in e)e.hasOwnProperty(t)&&this.removeCallout(t)},this.removeCallout=function(t){var r=e[t]
e[t]=null,n[t]=null,r&&r.destroy()},this.refreshCalloutPositions=function(){var t,r,i
for(t in e)e.hasOwnProperty(t)&&n.hasOwnProperty(t)&&(r=e[t],i=n[t],r&&i&&r.setPosition(i))}},e=function(e){var r,f,g,v,_,E,w,k,x=this,C={},O=[],P=function(e){return r&&r.element&&r.element.parentNode||(r=new t(g)),e&&a.extend(r.opt,{bubblePadding:T("bubblePadding"),bubbleWidth:T("bubbleWidth"),showNextButton:T("showNextButton"),showPrevButton:T("showPrevButton"),showCloseButton:T("showCloseButton"),arrowWidth:T("arrowWidth"),isRtl:T("isRtl")}),r},S=function(){r&&(r.destroy(),r=null)},T=function(e){return void 0===g?c[e]:a.valOrDefault(g[e],c[e])},R=function(){return!v||_<0||_>=v.steps.length?null:v.steps[_]},A=function(){x.nextStep()},N=function e(t,n){var r,i
_+t>=0&&_+t<v.steps.length?(_+=t,i=function(){a.getStepTarget(r)?(C[_]&&delete C[_],n(_)):(C[_]=!0,a.invokeEventCallbacks("error"),e(t,n))},(r=R()).delay?setTimeout(i,r.delay):i()):n(-1)},M=function(e,t){var n,r,i,o,s=P(),u=this
if(s.hide(),e=a.valOrDefault(e,!0),(n=R()).nextOnTargetClick&&a.removeEvtListener(a.getStepTarget(n),"click",A),r=n,i=t>0?r.multipage:_>0&&v.steps[_-1].multipage,o=function(n){var o
if(-1===n)return this.endTour(!0)
e&&(o=t>0?a.invokeEventCallbacks("next",r.onNext):a.invokeEventCallbacks("prev",r.onPrev)),n===_&&(i?L():(o=a.valOrDefault(o,!0))?this.showStep(n):this.endTour(!1))},!i&&T("skipIfNoElement"))N(t,function(e){o.call(u,e)})
else if(_+t>=0&&_+t<v.steps.length){if(_+=t,n=R(),!a.getStepTarget(n)&&!i)return a.invokeEventCallbacks("error"),this.endTour(!0,!1)
o.call(this,_)}else if(_+t===v.steps.length)return this.endTour()
return this},j=function(e,t,n){var r,i
if(_=e||0,C=t||{},r=R(),i=a.getStepTarget(r))n(_)
else if(!i){if(a.invokeEventCallbacks("error"),C[_]=!0,T("skipIfNoElement"))return void N(1,n)
n(_=-1)}},I=function(e){var t=v.steps[e],n=P(),r=a.getStepTarget(t)
function i(){n.show(),a.invokeEventCallbacks("show",t.onShow)}_!==e&&R().nextOnTargetClick&&a.removeEvtListener(a.getStepTarget(R()),"click",A),_=e,n.hide(!1),n.render(t,e,function(e){var n,o,s,u,l,c,p,h,f,m,g,v,y,_,E,w,k,x
e?(n=i,h=P().element,f=a.getPixelValue(h.style.top),m=f+a.getPixelValue(h.offsetHeight),g=a.getStepTarget(R()).getBoundingClientRect(),v=g.top+a.getScrollTop(),y=g.bottom+a.getScrollTop(),_=f<v?f:v,E=m>y?m:y,w=a.getScrollTop(),k=w+a.getWindowHeight(),x=_-T("scrollTopMargin"),_>=w&&(_<=w+T("scrollTopMargin")||E<=k)?n&&n():T("smoothScroll")?"undefined"!==("undefined"==typeof YAHOO?"undefined":d(YAHOO))&&"undefined"!==d(YAHOO.env)&&"undefined"!==d(YAHOO.env.ua)&&"undefined"!==d(YAHOO.util)&&"undefined"!==d(YAHOO.util.Scroll)?(o=YAHOO.env.ua.webkit?document.body:document.documentElement,u=YAHOO.util.Easing?YAHOO.util.Easing.easeOut:void 0,(s=new YAHOO.util.Scroll(o,{scroll:{to:[0,x]}},T("scrollDuration")/1e3,u)).onComplete.subscribe(n),s.animate()):b?jQuery("body, html").animate({scrollTop:x},T("scrollDuration"),n):(x<0&&(x=0),l=w>_?-1:1,c=Math.abs(w-x)/(T("scrollDuration")/10),(p=function(){var e=a.getScrollTop(),t=e+l*c
if(l>0&&t>=x||l<0&&t<=x)return t=x,n&&n(),void window.scrollTo(0,t)
window.scrollTo(0,t),a.getScrollTop()!==e?setTimeout(p,10):n&&n()})()):(window.scrollTo(0,x),n&&n())):i(),t.nextOnTargetClick&&a.addEvtListener(r,"click",A)}),L()},L=function(){var e=v.id+":"+_,t=p.getSkippedStepsIndexes()
t&&t.length>0&&(e+=":"+t.join(",")),a.setState(T("cookieName"),e,1)}
this.getCalloutManager=function(){return"undefined"===(void 0===f?"undefined":d(f))&&(f=new n),f},this.startTour=function(e,t){var n,r={},i=this
if(!v){if(!e)throw new Error("Tour data is required for startTour.")
if(!e.id||!y.test(e.id))throw new Error("Tour ID is using an invalid format. Use alphanumeric, underscores, and/or hyphens only. First character must be a letter.")
v=e,function(e){var t,n,r,i={}
for(t in e)e.hasOwnProperty(t)&&"id"!==t&&"steps"!==t&&(i[t]=e[t])
return k.call(this,i,!0),(n=a.getState(T("cookieName")))&&(r=n.split(":"),E=r[0],w=r[1],r.length>2&&(O=r[2].split(",")),w=parseInt(w,10)),this}.call(this,e)}if("undefined"!==(void 0===t?"undefined":d(t))){if(t>=v.steps.length)throw new Error("Specified step number out of bounds.")
n=t}if(!a.documentIsReady())return m=!0,this
if(void 0===n&&v.id===E&&"undefined"!==(void 0===w?"undefined":d(w))){if(n=w,O.length>0)for(var o=0,s=O.length;o<s;o++)r[O[o]]=!0}else n||(n=0)
return j(n,r,function(e){-1!==e&&a.getStepTarget(v.steps[e])?(a.invokeEventCallbacks("start"),P().hide(!1),i.isActive=!0,a.getStepTarget(R())?i.showStep(e):(a.invokeEventCallbacks("error"),T("skipIfNoElement")&&i.nextStep(!1))):i.endTour(!1,!1)}),this},this.showStep=function(e){var t=v.steps[e],n=_
return a.getStepTarget(t)?(t.delay?setTimeout(function(){I(e)},t.delay):I(e),this):(_=e,a.invokeEventCallbacks("error"),void(_=n))},this.prevStep=function(e){return M.call(this,e,-1),this},this.nextStep=function(e){return M.call(this,e,1),this},this.endTour=function(e,t){var n,r=P()
return e=a.valOrDefault(e,!0),t=a.valOrDefault(t,!0),v&&(n=R())&&n.nextOnTargetClick&&a.removeEvtListener(a.getStepTarget(n),"click",A),_=0,w=void 0,r.hide(),e&&a.clearState(T("cookieName")),this.isActive&&(this.isActive=!1,v&&t&&a.invokeEventCallbacks("end")),this.removeCallbacks(null,!0),this.resetDefaultOptions(),S(),v=null,this},this.getCurrTour=function(){return v},this.getCurrTarget=function(){return a.getStepTarget(R())},this.getCurrStepNum=function(){return _},this.getSkippedStepsIndexes=function(){var e,t=[]
for(e in C)t.push(e)
return t},this.refreshBubblePosition=function(){var e=R()
return e&&P().setPosition(e),this.getCalloutManager().refreshCalloutPositions(),this},this.listen=function(e,t,n){return e&&u[e].push({cb:t,fromTour:n}),this},this.unlisten=function(e,t){var n,r,i=u[e]
for(n=0,r=i.length;n<r;++n)i[n].cb===t&&i.splice(n,1)
return this},this.removeCallbacks=function(e,t){var n,r,i,o
for(o in u)if(!e||e===o)if(t)for(r=0,i=(n=u[o]).length;r<i;++r)n[r].fromTour&&(n.splice(r--,1),--i)
else u[o]=[]
return this},this.registerHelper=function(e,t){"string"==typeof e&&"function"==typeof t&&(l[e]=t)},this.unregisterHelper=function(e){l[e]=null},this.invokeHelper=function(e){var t,n,r=[]
for(t=1,n=arguments.length;t<n;++t)r.push(arguments[t])
l[e]&&l[e].call(null,r)},this.setCookieName=function(e){return g.cookieName=e,this},this.resetDefaultOptions=function(){return g={},this},this.resetDefaultI18N=function(){return i={},this},this.getState=function(){return a.getState(T("cookieName"))},k=function(e,t){var n,r,o,s=["next","prev","start","end","show","error","close"]
for(g||this.resetDefaultOptions(),a.extend(g,e),e&&a.extend(i,e.i18n),r=0,o=s.length;r<o;++r)e[n="on"+s[r].charAt(0).toUpperCase()+s[r].substring(1)]&&this.listen(s[r],e[n],t)
return P(!0),this},this.configure=function(e){return k.call(this,e,!1)},this.setRenderer=function(e){var t=void 0===e?"undefined":d(e)
return"string"===t?(h=e,o=void 0):"function"===t&&(o=e),this},this.setEscaper=function(e){return"function"==typeof e&&(s=e),this},function(e){e&&this.configure(e)}.call(this,e)},p=new e,function(){var e={escape:function(e){return s?s(e):null==e?"":(""+e).replace(new RegExp("[&<>\"']","g"),function(e){return"&"==e?"&amp;":"<"==e?"&lt;":">"==e?"&gt;":'"'==e?"&quot;":"'"==e?"&#x27;":void 0})}}
this.templates=this.templates||{},this.templates.bubble_default=function(t){var n,r=""
e.escape,Array.prototype.join
function i(t,n){return n?e.escape(t):t}r+="\n"
var o=t.i18n,s=t.buttons,a=t.step,u=t.tour
return r+='\n<div class="hopscotch-bubble-container" style="width: '+(null==(n=a.width)?"":n)+"px; padding: "+(null==(n=a.padding)?"":n)+'px;">\n  ',u.isTour&&(r+='<span class="hopscotch-bubble-number">'+(null==(n=o.stepNum)?"":n)+"</span>"),r+='\n  <div class="hopscotch-bubble-content">\n    ',""!==a.title&&(r+='<h3 class="hopscotch-title">'+(null==(n=i(a.title,u.unsafe))?"":n)+"</h3>"),r+="\n    ",""!==a.content&&(r+='<div class="hopscotch-content">'+(null==(n=i(a.content,u.unsafe))?"":n)+"</div>"),r+='\n  </div>\n  <div class="hopscotch-actions">\n    ',s.showPrev&&(r+='<button class="hopscotch-nav-button prev hopscotch-prev">'+(null==(n=o.prevBtn)?"":n)+"</button>"),r+="\n    ",s.showCTA&&(r+='<button class="hopscotch-nav-button next hopscotch-cta">'+(null==(n=s.ctaLabel)?"":n)+"</button>"),r+="\n    ",s.showNext&&(r+='<button class="hopscotch-nav-button next hopscotch-next">'+(null==(n=o.nextBtn)?"":n)+"</button>"),r+="\n  </div>\n  ",s.showClose&&(r+='<button class="hopscotch-bubble-close hopscotch-close">'+(null==(n=o.closeTooltip)?"":n)+"</button>"),r+='\n</div>\n<div class="hopscotch-bubble-arrow-container hopscotch-arrow">\n  <div class="hopscotch-bubble-arrow-border"></div>\n  <div class="hopscotch-bubble-arrow"></div>\n</div>\n'}}.call(p),p}),"undefined"==typeof FastBoot&&function(e,t){"object"==typeof exports&&"undefined"!=typeof module?module.exports=t():"function"==typeof define&&define.amd?define(t):e.Popper=t()}(this,function(){"use strict"
...
function k(e){return w({},e,{right:e.left+e.width,bottom:e.top+e.height})}function x(e){var t={}
...
if(l||c){var d=s(e)
l-=b(d,"x"),c-=b(d,"y"),i.width-=l,i.height-=c}return k(i)}function C(e,t){var n=arguments.length>2&&void 0!==arguments[2]&&arguments[2],r=p(10),i="HTML"===t.nodeName,o=x(e),a=x(t),l=u(e),c=s(t),d=parseFloat(c.borderTopWidth,10),h=parseFloat(c.borderLeftWidth,10)
n&&i&&(a.top=Math.max(a.top,0),a.left=Math.max(a.left,0))
var f=k({top:o.top-a.top-d,left:o.left-a.left-h,width:o.width,height:o.height})
...
return t||document.documentElement}function P(e,t,n,r){var i=arguments.length>4&&void 0!==arguments[4]&&arguments[4],o={top:0,left:0},l=i?O(e):f(e,t)
...
return k({top:s-r.top+r.marginTop,left:a-r.left+r.marginLeft,width:i,height:o})}(l,i)
else{var c=void 0
...
var s=P(n,r,o,i),a={top:{width:s.width,height:t.top-s.top},right:{width:s.right-t.right,height:s.height},bottom:{width:s.width,height:s.bottom-t.bottom},left:{width:t.left-s.left,height:s.height}},u=Object.keys(a).map(function(e){return w({key:e},a[e],{area:(t=a[e],t.width*t.height)})
...
return C(n,r?O(t):f(t,n),r)}function R(e){var t=getComputedStyle(e),n=parseFloat(t.marginTop)+parseFloat(t.marginBottom),r=parseFloat(t.marginLeft)+parseFloat(t.marginRight)
...
e.enabled&&o(n)&&(t.offsets.popper=k(t.offsets.popper),t.offsets.reference=k(t.offsets.reference),t=n(t,e))}),t}function I(e,t){return e.some(function(e){var n=e.name
...
switch(s){case"%p":a=n
break
case"%":case"%r":default:a=r}return k(a)[t]/100*o}if("vh"===s||"vw"===s)return("vh"===s?Math.max(document.documentElement.clientHeight,window.innerHeight||0):Math.max(document.documentElement.clientWidth,window.innerWidth||0))/100*o
...
var i=e.placement.split("-")[0],o=e.offsets,a=o.popper,u=o.reference,l=-1!==["left","right"].indexOf(i),c=l?"height":"width",p=l?"Top":"Left",d=p.toLowerCase(),h=l?"left":"top",f=l?"bottom":"right",m=R(r)[c]
u[f]-m<a[d]&&(e.offsets.popper[d]-=a[d]-(u[f]-m)),u[d]+m>a[f]&&(e.offsets.popper[d]+=u[d]+m-a[f]),e.offsets.popper=k(e.offsets.popper)
...
var n=P(e.instance.popper,e.instance.reference,t.padding,t.boundariesElement,e.positionFixed),r=e.placement.split("-")[0],i=A(r),o=e.placement.split("-")[1]||"",s=[]
...
return i[s?"left":"top"]=o[n]-(a?i[s?"width":"height"]:0),e.placement=A(t),e.offsets.popper=k(i),e}},hide:{order:800,enabled:!0,fn:function(e){if(!H(e.instance.modifiers,"hide","preventOverflow"))return e
...
var s=void 0!==o?o:t.gpuAcceleration,a=d(e.instance.popper),u=x(a),l={position:i.position},c={left:Math.floor(i.left),top:Math.round(i.top),bottom:Math.round(i.bottom),right:Math.floor(i.right)},p="bottom"===n?"top":"bottom",h="right"===r?"left":"right",f=L("transform"),m=void 0,b=void 0
...
return U(e.instance.popper,e.styles),t=e.instance.popper,n=e.attributes,Object.keys(n).forEach(function(e){!1!==n[e]?t.setAttribute(e,n[e]):t.removeAttribute(e)}),e.arrowElement&&Object.keys(e.arrowStyles).length&&U(e.arrowElement,e.arrowStyles),e},onLoad:function(e,t,n,r,i){var o=T(i,t,e,n.positionFixed),s=S(n.placement,o,t,e,n.modifiers.flip.boundariesElement,n.modifiers.flip.padding)
...
e.offsets.reference=T(this.state,this.popper,this.reference,this.options.positionFixed),e.placement=S(this.options.placement,e.offsets.reference,this.popper,this.reference,this.options.modifiers.flip.boundariesElement,this.options.modifiers.flip.padding),e.originalPlacement=e.placement,e.positionFixed=this.options.positionFixed,e.offsets.popper=N(this.popper,e.offsets.reference,e.placement),e.offsets.popper.position=this.options.positionFixed?"fixed":"absolute",e=j(this.modifiers,e),this.state.isCreated?this.options.onUpdate(e):(this.state.isCreated=!0,this.options.onCreate(e))}}.call(this)}},{key:"destroy",value:function(){return function(){return this.state.isDestroyed=!0,I(this.modifiers,"applyStyle")&&(this.popper.removeAttribute("x-placement"),this.popper.style.position="",this.popper.style.top="",this.popper.style.left="",this.popper.style.right="",this.popper.style.bottom="",this.popper.style.willChange="",this.popper.style[L("transform")]=""),this.disableEventListeners(),this.options.removeOnDestroy&&this.popper.parentNode.removeChild(this.popper),this}.call(this)}},{key:"enableEventListeners",value:function(){return function(){this.state.eventsEnabled||(this.state=B(this.reference,this.options,this.state,this.scheduleUpdate))}.call(this)}},{key:"disableEventListeners",value:function(){return F.call(this)}}]),e}()
...
for(var p=0;p<c.length;++p){var d=c[p],h=d.inside,f=!!d.lookbehind,m=!!d.greedy,b=0,g=d.alias
if(m&&!d.pattern.global){var v=d.pattern.toString().match(/[imuy]*$/)[0]
d.pattern=RegExp(d.pattern.source,v+"g")}d=d.pattern||d
for(var y=i,_=o;y<t.length;_+=t[y].length,++y){var E=t[y]
if(t.length>e.length)return
if(!(E instanceof u)){if(m&&y!=t.length-1){if(d.lastIndex=_,!(P=d.exec(e)))break
for(var w=P.index+(f?P[1].length:0),k=P.index+P[0].length,x=y,C=_,O=t.length;x<O&&(C<k||!t[x].type&&!t[x-1].greedy);++x)w>=(C+=t[x].length)&&(++y,_=C)
if(t[y]instanceof u)continue
S=x-y,E=e.slice(_,C),P.index-=_}else{d.lastIndex=0
var P=d.exec(E),S=1}if(P){f&&(b=P[1]?P[1].length:0)
k=(w=P.index+b)+(P=P[0].slice(b)).length
var T=E.slice(0,w),R=E.slice(k),A=[y,S]
T&&(++y,_+=T.length,A.push(T))
var N=new u(l,h?n.tokenize(P,h):P,g,P,m)
if(A.push(N),R&&A.push(R),Array.prototype.splice.apply(t,A),1!=S&&n.matchGrammar(e,t,r,y,_,!0,l),s)break}else if(s)break}}}}},tokenize:function(e,t,r){var i=[e],o=t.rest
...
return r.textContent=t.getAttribute("data-download-link-label")||"Download",r.setAttribute("download",""),r.href=n,r}})},document.addEventListener("DOMContentLoaded",self.Prism.fileHighlight)),function(e){var t={variable:[{pattern:/\$?\(\([\s\S]+?\)\)/,inside:{variable:[{pattern:/(^\$\(\([\s\S]+)\)\)/,lookbehind:!0},/^\$\(\(/],number:/\b0x[\dA-Fa-f]+\b|(?:\b\d+\.?\d*|\B\.\d+)(?:[Ee]-?\d+)?/,operator:/--?|-=|\+\+?|\+=|!=?|~|\*\*?|\*=|\/=?|%=?|<<=?|>>=?|<=?|>=?|==?|&&?|&=|\^=?|\|\|?|\|=|\?|:/,punctuation:/\(\(?|\)\)?|,|;/}},{pattern:/\$\([^)]+\)|`[^`]+`/,greedy:!0,inside:{variable:/^\$\(|^`|\)$|`$/}},/\$(?:[\w#?*!@]+|\{[^}]+\})/i]}
...
if("string"==typeof a||a.content&&"string"==typeof a.content){var u=r[n],l=e.tokenStack[u],c="string"==typeof a?a:a.content,p=c.indexOf("___"+t.toUpperCase()+u+"___")
if(p>-1){++n
var d,h=c.substring(0,p),f=new Prism.Token(t,Prism.tokenize(l,e.grammar,t),"language-"+t,l),m=c.substring(p+("___"+t.toUpperCase()+u+"___").length)
if(h||m?(d=[h,f,m].filter(function(e){return!!e}),i(d)):d=f,"string"==typeof a?Array.prototype.splice.apply(o,[s,1].concat(d)):a.content=d,n>=r.length)break}}else a.content&&"string"!=typeof a.content&&i(a.content)}}
i(e.tokens)}}}}),function(){if("undefined"!=typeof self&&self.Prism&&self.document&&document.querySelector){var e,t=function(){if(void 0===e){var t=document.createElement("div")
...
r(".line-highlight",t).forEach(function(e){i+=e.textContent.length,e.parentNode.removeChild(e)}),i&&/^( \n)+$/.test(e.code.slice(-i))&&(e.code=e.code.slice(0,-i))}}),Prism.hooks.add("complete",function e(t){var r=t.element.parentNode,a=r&&r.getAttribute("data-line")
if(r&&a&&/pre/i.test(r.nodeName)){clearTimeout(n)
var u=Prism.plugins.lineNumbers,l=t.plugins&&t.plugins.lineNumbers
i(r,"line-numbers")&&u&&!l?Prism.hooks.add("line-numbers",e):(o(r,a),n=setTimeout(s,1))}}),window.addEventListener("hashchange",s),window.addEventListener("resize",function(){var e=document.querySelectorAll("pre[data-line]")
Array.prototype.forEach.call(e,function(e){o(e)})})}function r(e,t){return Array.prototype.slice.call((t||document).querySelectorAll(e))}function i(e,t){return t=" "+t+" ",(" "+e.className+" ").replace(/[\n\t]/g," ").indexOf(t)>-1}function o(e,n,r){for(var o,s=(n="string"==typeof n?n:e.getAttribute("data-line")).replace(/\s+/g,"").split(","),a=+e.getAttribute("data-line-offset")||0,u=(t()?parseInt:parseFloat)(getComputedStyle(e).lineHeight),l=i(e,"line-numbers"),c=0;o=s[c++];){var p=o.split("-"),d=+p[0],h=+p[1]||d,f=e.querySelector('.line-highlight[data-range="'+o+'"]')||document.createElement("div")
if(f.setAttribute("aria-hidden","true"),f.setAttribute("data-range",o),f.className=(r||"")+" line-highlight",l&&Prism.plugins.lineNumbers){var m=Prism.plugins.lineNumbers.getLine(e,d),b=Prism.plugins.lineNumbers.getLine(e,h)
m&&(f.style.top=m.offsetTop+"px"),b&&(f.style.height=b.offsetTop-m.offsetTop+b.offsetHeight+"px")}else f.setAttribute("data-start",d),h>d&&f.setAttribute("data-end",h),f.style.top=(d-a-1)*u+"px",f.textContent=new Array(h-d+2).join(" \n")
l?e.appendChild(f):(e.querySelector("code")||e).appendChild(f)}}function s(){var e=location.hash.slice(1)
...
i&&(i.hasAttribute("data-line")||i.setAttribute("data-line",""),o(i,t,"temporary "),document.querySelector(".temporary.line-highlight").scrollIntoView())}}}(),createDeprecatedModule("ember/resolver"),createDeprecatedModule("resolver"),define("@ember-decorators/argument/index",["exports","ember-get-config","@ember-decorators/argument/utils/make-computed"],function(e,t,n){"use strict"
...
Ember.addObserver(e,l,void 0,t)}}catch(c){o=!0,s=c}finally{try{!i&&u.return&&u.return()}finally{if(o)throw s}}}),e.unobserves=(0,r.decoratorWithRequiredParams)(function(e,t,n,r){var i=!0,o=!1,s=void 0
try{for(var a,u=r[Symbol.iterator]();!(i=(a=u.next()).done);i=!0){var l=a.value
Ember.removeObserver(e,l,void 0,t)}}catch(c){o=!0,s=c}finally{try{!i&&u.return&&u.return()}finally{if(o)throw s}}}),e.on=(0,r.decoratorWithRequiredParams)(function(e,t,n,r){var i=!0,o=!1,s=void 0
try{for(var a,u=r[Symbol.iterator]();!(i=(a=u.next()).done);i=!0){var l=a.value
Ember.addListener(e,l,void 0,t)}}catch(c){o=!0,s=c}finally{try{!i&&u.return&&u.return()}finally{if(o)throw s}}}),e.off=(0,r.decoratorWithRequiredParams)(function(e,t,n,r){var i=!0,o=!1,s=void 0
try{for(var a,u=r[Symbol.iterator]();!(i=(a=u.next()).done);i=!0){var l=a.value
Ember.removeListener(e,l,void 0,t)}}catch(c){o=!0,s=c}finally{try{!i&&u.return&&u.return()}finally{if(o)throw s}}})}),define("@ember-decorators/service/index",["exports","@ember-decorators/utils/computed"],function(e,t){"use strict"
...
0===c.lastIndexOf(i,0)?n(c,"-test")||s.push(c):0===c.lastIndexOf(o,0)&&(n(c,"-test")||a.push(c))}(function(e,n){for(var r=0;r<n.length;r++)e.initializer(t(n[r]))})(e,s),function(e,n){for(var r=0;r<n.length;r++)e.instanceInitializer(t(n[r]))}(e,a)}}),define("ember-page-title/helpers/page-title",["exports"],function(e){"use strict"
...
n.parentNode.removeChild(n)}},_hasFastboot:function(){return!!Ember.getOwner(this).lookup("service:fastboot")}})}),define("ember-popper/components/ember-popper-base",["exports","ember-popper/templates/components/ember-popper","@ember-decorators/object","@ember-decorators/argument","ember-raf-scheduler","@ember-decorators/component"],function(e,t,n,r,i,o){"use strict"
...
return!t||"object"!=typeof t&&"function"!=typeof t?e:t}var l,c,p,d,h,f,m,b,g,v,y,_,E,w,k,x,C,O,P
function S(e,t,n,r,i){var o={}
return Object.keys(r).forEach(function(e){o[e]=r[e]}),o.enumerable=!!o.enumerable,o.configurable=!!o.configurable,("value"in o||o.initializer)&&(o.writable=!0),o=n.slice().reverse().reduce(function(n,r){return r(e,t,n)||n},o),i&&void 0!==o.initializer&&(o.value=o.initializer?o.initializer.call(i):void 0,o.initializer=void 0),void 0===o.initializer&&(Object.defineProperty(e,t,o),o=null),o}var T=(l=(0,o.tagName)(""),c=(0,r.argument)({defaultIfUndefined:!0}),p=(0,r.argument)({defaultIfUndefined:!1}),d=(0,r.argument)({defaultIfUndefined:!0}),h=(0,r.argument)({defaultIfUndefined:!0}),f=(0,r.argument)({defaultIfUndefined:!0}),m=(0,n.computed)("_renderInPlace","popperContainer"),b=(0,n.computed)("renderInPlace"),l((v=function(e){function n(){var e,r,i;(function(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")})(this,n)
for(var o=arguments.length,a=Array(o),l=0;l<o;l++)a[l]=arguments[l]
return r=i=u(this,(e=n.__proto__||Object.getPrototypeOf(n)).call.apply(e,[this].concat(a))),i.layout=t.default,s(i,"eventsEnabled",y,i),s(i,"hidden",_,i),s(i,"modifiers",E,i),s(i,"onCreate",w,i),s(i,"onUpdate",k,i),s(i,"placement",x,i),s(i,"popperContainer",C,i),s(i,"registerAPI",O,i),s(i,"renderInPlace",P,i),i._didRenderInPlace=!1,i._eventsEnabled=null,i._initialParentNode=null,i._modifiers=null,i._onCreate=null,i._onUpdate=null,i._placement=null,i._popper=null,i._popperTarget=null,i._publicAPI=null,i._updateRAF=null,u(i,r)}return function(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t)
...
n=i[0]}return n}},{key:"_renderInPlace",get:function(){return!self.document||!!this.get("renderInPlace")}}]),n}(),y=S(v.prototype,"eventsEnabled",[c],{enumerable:!0,initializer:function(){return!0}}),_=S(v.prototype,"hidden",[p],{enumerable:!0,initializer:function(){return!1}}),E=S(v.prototype,"modifiers",[r.argument],{enumerable:!0,initializer:function(){return null}}),w=S(v.prototype,"onCreate",[r.argument],{enumerable:!0,initializer:function(){return null}}),k=S(v.prototype,"onUpdate",[r.argument],{enumerable:!0,initializer:function(){return null}}),x=S(v.prototype,"placement",[d],{enumerable:!0,initializer:function(){return"bottom"}}),C=S(v.prototype,"popperContainer",[h],{enumerable:!0,initializer:function(){return".ember-application"}}),O=S(v.prototype,"registerAPI",[r.argument],{enumerable:!0,initializer:function(){return null}}),P=S(v.prototype,"renderInPlace",[f],{enumerable:!0,initializer:function(){return!1}}),S(v.prototype,"update",[n.action],Object.getOwnPropertyDescriptor(v.prototype,"update"),v.prototype),S(v.prototype,"scheduleUpdate",[n.action],Object.getOwnPropertyDescriptor(v.prototype,"scheduleUpdate"),v.prototype),S(v.prototype,"enableEventListeners",[n.action],Object.getOwnPropertyDescriptor(v.prototype,"enableEventListeners"),v.prototype),S(v.prototype,"disableEventListeners",[n.action],Object.getOwnPropertyDescriptor(v.prototype,"disableEventListeners"),v.prototype),S(v.prototype,"_popperContainer",[m],Object.getOwnPropertyDescriptor(v.prototype,"_popperContainer"),v.prototype),S(v.prototype,"_renderInPlace",[b],Object.getOwnPropertyDescriptor(v.prototype,"_renderInPlace"),v.prototype),g=v))||g)
...
Object.defineProperty(e,"__esModule",{value:!0}),e.default=Ember.Component.extend({classNameBindings:["languageClass"],inline:!1,language:"markup",languageClass:Ember.computed("language",function(){return"language-"+this.get("language")}),getElement:function(){return this.element},didInsertElement:function(){Prism.highlightElement(this.getElement())}})})
define("ember-prism/components/code-block",["exports","ember-prism/components/code-base"],function(e,t){"use strict"
...
t&&(t.on("tour.start",function(t){e._sendAction("tourStarted",t)}),t.on("tour.end",function(t){e._sendAction("tourEnded",t)}),t.on("tour.close",function(t){e._sendAction("tourClosed",t)}),t.on("callout.show",function(t){e._sendAction("calloutShown",t)}),t.on("callout.close",function(t){e._sendAction("calloutClosed",t)}))},_sendAction:function(e){for(var t=Ember.get(this,e),n=arguments.length,i=Array(n>1?n-1:0),o=1;o<n;o++)i[o-1]=arguments[o]
if(t&&"function"===Ember.typeOf(t))return t.apply(void 0,r(i))
this.sendAction.apply(this,[e].concat(r(i)))},_tearDownEventListeners:function(){var e=Ember.get(this,"tour")
e&&(e.off("tour.start"),e.off("tour.end"),e.off("tour.close"),e.off("callout.show"),e.off("callout.close"))},didInsertElement:function(){var e=Ember.get(this,"tourManager"),t=Ember.get(this,"tour"),r=Ember.get(this,"callout"),i=Ember.get(this,"calloutPlacement")||"top",o=this.element,s=n(o.children,1)[0]
if(t&&r&&s){e.addCallout(t,{calloutMessage:r,placement:i,target:s})
...
Object.defineProperty(e,"__esModule",{value:!0})
var t=e.SetupControllerMixin=Ember.Mixin.create({tourManager:Ember.inject.service(),setupController:function(e,t){if(this._super.apply(this,arguments),!Ember.get(e,"tour")){var n=Ember.get(this,"routeName"),r=Ember.get(this,"tourManager").setupTour(n,t)
Ember.set(e,"tour",r)}}}),n=e.ResetControllerMixin=Ember.Mixin.create({tourManager:Ember.inject.service(),resetController:function(e,t){if(t){Ember.get(this,"tourManager").closeCallout()
var n=Ember.get(e,"tour")
n&&(n.close(),n.destroy()),Ember.set(e,"tour",null)}return this._super.apply(this,arguments)}})
...
Object.defineProperty(e,"__esModule",{value:!0}),e.default=Ember.Service.extend({hopscotch:Ember.computed(function(){return hopscotch}),messages:Ember.computed(function(){return{nextBtn:"Next",prevBtn:"Previous",closeTooltip:"Close",skipBtn:"Skip",doneBtn:"Done",defaultCalloutTitle:"Start a tour!",stepCount:"Step %step% of %stepCount%"}}),owner:Ember.computed(function(){return Ember.getOwner(this)}),_calloutManager:null,_localStorageKey:"ember-site-tour",includeStepCount:!0,showCallout:function(e){var t=this,n=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},r=!(arguments.length>2&&void 0!==arguments[2])||arguments[2],i=this.get("_calloutManager")
if(!r||!this.getIsRead(e)&&n.target){var o=Ember.assign({id:e,onClose:function(){return t.setIsRead(e)}},n)
i.getCallout(e)&&i.removeCallout(e),i.createCallout(o)}},closeCallout:function(e){var t=!(arguments.length>1&&void 0!==arguments[1])||arguments[1],n=this.get("_calloutManager")
e?(n.removeCallout(e),t&&this.setIsRead(e)):n.removeAllCallouts()},setupTour:function(e,n){var r=this._setupTourSteps(e,n),i=Ember.get(this,"owner")
return t.default.create(i.ownerInjection(),{tourId:e,steps:r,model:n})},addCallout:function(e,t){var n=t.calloutTitle,r=t.calloutMessage,i=t.placement,o=void 0===i?"top":i,s=t.target
n=n||Ember.get(this,"messages.defaultCalloutTitle")
var a={id:e.get("tourId")+"-callout",target:s,placement:o,title:this._t(n),content:this._t(r)}
return e.set("calloutOptions",a),e},getIsRead:function(e){if(!window.localStorage||!e)return!1
var t=Ember.get(this,"_localStorageKey"),n=null
try{n=window.localStorage.getItem(t)}catch(r){console.error("Could not read from local storage.",r)}return!!n&&(n=JSON.parse(n))[e]},setIsRead:function(e){var t=!(arguments.length>1&&void 0!==arguments[1])||arguments[1]
if(window.localStorage){var n=Ember.get(this,"_localStorageKey"),r=window.localStorage.getItem(n);(r=r?JSON.parse(r):{})[e]=t
try{window.localStorage.setItem(n,JSON.stringify(r))}catch(i){console.error("Could not save to local storage.",i)}}},_setupTourSteps:function(e,t){return this._loadTour(e,t)},_loadTour:function(e){var t=this,n=Ember.get(this,"owner").factoryFor("tour:"+e)||[],r=[],i=void 0
switch(Ember.typeOf(n.class)){case"array":r=n.class
break
case"function":r=n.class(e)
break
case"class":i=n.create({tourId:e}),r=Ember.get(i,"tour")||[]}return(n=Ember.A(r)).map(function(e){return{condition:Ember.get(e,"condition"),target:Ember.get(e,"target"),placement:Ember.get(e,"placement")||"top",title:t._t(Ember.get(e,"title")),content:t._t(Ember.get(e,"content"))}})},_t:function(e){return e},_configureHopscotch:function(){hopscotch.configure({i18n:{nextBtn:this._t(Ember.get(this,"messages.nextBtn")),prevBtn:this._t(Ember.get(this,"messages.prevBtn")),skipBtn:this._t(Ember.get(this,"messages.skipBtn")),doneBtn:this._t(Ember.get(this,"messages.doneBtn")),closeTooltip:this._t(Ember.get(this,"messages.closeTooltip"))}})},init:function(){var e=hopscotch.getCalloutManager()
...
var i=hopscotch.getCurrStepNum()
return Ember.set(this,"currentStep",i),this._onStart(),new Ember.RSVP.Promise(function(t){return Ember.run.next(e,t)})},_gotoNextStep:function(){return Ember.set(this,"currentStep",hopscotch.getCurrStepNum()),new Ember.RSVP.Promise(function(e){return Ember.run.next(e)})},_gotoPrevStep:function(){return Ember.set(this,"currentStep",hopscotch.getCurrStepNum()),new Ember.RSVP.Promise(function(e){return Ember.run.next(e)})},close:function(){var e=Ember.get(this,"tourId"),t=this._normalizeHopscotchId(e)
...
if(n){var r=n.id,i=this.get("_calloutManager"),o=Ember.get(this,"tourManager"),s=this._normalizeHopscotchId(r)
if(!t&&o.getIsRead(r)||"RUNNING"===this.get("status"))return!1
n&&(i.getCallout(s)&&i.removeCallout(s),n=Ember.assign({},n,{id:s,onClose:function(){return e._onCalloutClose()}}),this._onCalloutShow(),i.createCallout(n))}},hideCallout:function(){var e=Ember.get(this,"calloutOptions"),t=this.get("_calloutManager")
...
return e.forEach(function(e){var r=Ember.get(e,"target"),i="string"===Ember.typeOf(r)?document.querySelector(r):r,o=Ember.get(e,"condition"),s="function"!==Ember.typeOf(o)||o(t)
i&&s&&n.push({target:i,placement:Ember.get(e,"placement"),title:Ember.get(e,"title"),content:Ember.get(e,"content")})}),n=this._addTourStepCount(n),Ember.set(this,"_steps",n),n},_addTourStepCount:function(e){var t=Ember.get(this,"tourManager")
if(!t.get("includeStepCount"))return e
var n=e.length,r=Ember.get(t,"messages.stepCount").toString().replace("%stepCount%",n)
return e.map(function(e,t){var n=r.replace("%step%",t+1)
return Ember.assign({},e,{content:e.content+"<div class='hopscotch-pagination' data-test-site-tour-step=\""+(t+1)+'">'+n+"</div>"})})},_normalizeHopscotchId:function(e){return Ember.String.dasherize(Ember.String.classify(e))},init:function(){this._super.apply(this,arguments)
var e=hopscotch.getCalloutManager()
this.set("_calloutManager",e)},willDestroy:function(){this._super.apply(this,arguments)
var e=Ember.get(this,"_calloutManager"),t=Ember.get(this,"calloutOptions")
if(t){var n=t.id,r=this._normalizeHopscotchId(n)
e.getCallout(r)&&e.removeCallout(r)}}})})
